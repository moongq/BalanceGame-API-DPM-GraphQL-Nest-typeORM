...
export declare class BalanceGameResolver {
    ...
    createBalanceGame(token: UserJwt, imageOfSelection0: FileUpload, imageOfSelection1: FileUpload, createBalanceGameInput: CreateBalanceGameInput): Promise<BalanceGame>;
    uploadFile(file1: FileUpload): Promise<unknown>;
    findAll(balanceGamesState: BalanceGamesStateInput): Promise<BalanceGameList>;
    findAllLogined(balanceGamesState: BalanceGamesStateInput, token: UserJwt): Promise<BalanceGameList>;
    myGames(token: UserJwt): Promise<BalanceGameList>;
    ...
    findOneByRandom(token: UserJwt): Promise<BalanceGame>;
    ...
    myVotedGames(token: UserJwt): Promise<BalanceGame[]>;
}
